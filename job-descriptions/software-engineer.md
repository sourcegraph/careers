...
At Sourcegraph, we are building a better, smarter foundation for software development. The innovations of the future will increasingly rely on code, so if we can make software developers more productive, we can literally bring the future sooner.

We have already built the best [code search](https://about.sourcegraph.com/docs/search/) that is used and loved by large engineering organizations across the world.
Our [browser extensions](https://about.sourcegraph.com/product/browser) provide code intelligence (e.g. hover tooltips, go to definition, find references) when viewing code in your code host.
